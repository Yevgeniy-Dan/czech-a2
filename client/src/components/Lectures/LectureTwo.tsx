...
const LectureTwo: React.FC<React.PropsWithChildren<{}>> = (props) => {
  ...
  return (
    <div>
      ...
      <div>
        <p>
          <strong>А теперь к темам А2</strong>
        </p>
        <p>
      ...
      <div>
        ...
        <div>
          <p>
            <strong>
              Ниже представлен рисунок "Прошедшее время, форма «-L»".
            </strong>
          </p>
          <p>
            <i>
              Вы можете его сохранить и распечатать, либо переписать в свою
              рабочую тетрадь.
            </i>
          </p>
          <img
        ...
        <div>
          <p>
            <strong>
              Ниже представлена таблица "Прошедшее время глагола «být»".
            </strong>
          </p>
          <p>
            <i>
        ...
        <div className="card p-3">
          <p className="text-danger fw-bold mb-3">*Внимание!</p>
          <p className="fw-bold">Jít — идти / půjdu — пойду</p>
          <p className="fw-bold">Pojít — сдохнуть / pošel — сдох</p>
          <p className="fw-bold">
            Chci pojít — «хочу сдохнуть», а не «хочу пойти».
          </p>
          <p className="text-danger fw-bold mt-3">Не путайте эти глаголы!</p>
        </div>

        <div>
          <p className="fw-bold bg-warning">Прочтите и проговорите.</p>
          <p className="fw-bold">
          ...
          <p className="bg-warning">Прочтите и проговорите. </p>
          <p className="fw-bold">
            ВАЖНО! Абсолютно всё проговаривайте вслух, прочитайте, отведите
            глаза и повторите.
          </p>
        ...
        <div>
          <p className="fw-bold">
            Na obrázcích můžete uvidět použití minulého času.
          </p>
          <img
            ...
            height="auto"
          />
          <p className="bg-warning fw-bold">Tak co? Jdeme trénovat?</p>

          <div>
            <div>
              <p className="fw-bold">1. Napište věty v minulém čase:</p>
              <p>
            ...
            >
              <p className="fw-bold">
                <i>Внимание! Задание 2. проверяет преподаватель.</i>
                <p>
            ...
            <div>
              <p className="fw-bold"> 2. Napište, kdo a co dělal na obrázku.</p>
              <img
                src="https://czecha2bucket.s3.amazonaws.com/lekce_2/Task_2.1.jpg"
                alt=""
                width="100%"
                height="auto"
              />
            ...
            >
              <p className="fw-bold">
                Внимание! Задание 3. выполняется по желанию.
              </p>
            </div>

            <div>
              <p className="fw-bold">3. Napište věty v minulém čase:</p>
          ...
          <div>
            <p className="bg-warning fw-bold">
              Послушайте и повторите диалог вслух.
            </p>

            <figure>
              <audio
                controls
                src="https://czecha2bucket.s3.amazonaws.com/lekce_2/10-06.mp3"
              ></audio>
              <figcaption>
                <strong>Диалог A. Lucie a Ivana</strong>
              </figcaption>
            </figure>
            <p>Lucie: Co je nového, Ivano?</p>
            <p>Ivana: Nic.</p>
            <p>L: Jak to? Kde jsi byla o víkendu?</p>
            <p>I: Doma.</p>
            <p>L: Jak to? Neměla jsi jet s Madlou na výlet?</p>
            <p>I: Měla jsem jet, ale nejela jsem. Zůstala jsem doma.</p>
            <p>L: Proč?</p>
            <p>I: Madla ten výlet zrušila.</p>
            <p>L: Co se stalo?</p>
            <p>I: V pátek jí volal Matěj. Mluvili spolu asi hodinu.</p>
            <p>L: Takovou dobu?</p>
            <p>I: Ano.</p>
            <p>L: A co potom?</p>
            <p>
              I: Pak Madla přišla ke mně do pokoje a omluvila se. Řekla, že
              zítra nikam nepojede.
            </p>
            <p>L: Proč nechtěla jet?</p>
            <p>I: To mi nechtěla říct. Myslím, že má s Matějem rande.</p>
            <p>L: Vážně? Oni spolu chodí?</p>
            <p>I: Myslím, že ano.</p>
            <p>L: Myslíš? Ty to nevíš?</p>
            <p>I: Nevím.</p>
            <p>
              L: Ona ti neřekla, že má kluka? Jsi její nejlepší kamarádka, ne?
            </p>
            <p>
              I: Ona mi takové věci neříká. Vím ale něco od Šimona. Matěj řekl
              Šimonovi, že se mu Madla moc líbí.
            </p>
            <p>L: Kdy to řekl?</p>
            <p>I: Řekl to před víkendem</p>
            <p>L: Tak spolu možná chodí.</p>
            <p>
              L: No vidíš, a ty říkáš, že není nic nového. Taková zajímavá
              zpráva!
            </p>
          </div>
          ...
          <div>
            <p className="bg-warning fw-bold">
              Tady jsme pro Vás připravili text, kde jsou slovesa ve všech
              časech.
            </p>
            <p className="fw-bold">1. Čtěte nahlas a vypište neznámá slova.</p>

            <p className="fw-bold text-uppercase">Sport</p>
            <p>
              Táta: Ahoj, rodino, tak co podnikneme o víkendu? Navrhuju pořádný
              výlet na kolech, venku je konečně hezky.
            </p>
            <p>
              Máma: Ale Hynku, víš přece, že mám rozbité kolo? Nikdo mně ho
              ještě neopravil.
            </p>
            <p>
              Táta: No jo, ale to není problém, hned zítra se do toho dáme s
              Pepou.
            </p>
            <p>
              Pepa: Tati, já mám v sobotu zápas fotbalem, říkal jsem to už před
              týdnem.
            </p>
            <p>
              Gábina: A mně se nikam nechce, v televizi dávají v sobotu
              odpoledne super film s Nicolasem Cagem.
            </p>
            <p>
              Máma: Gábi, měla bys jet, když budeš pořád jen doma u televize,
              budeš za chvíli tlustá.
            </p>
            <p>
              Gábina: Když mi koupíte snowboard, pojedu s vámi v zimě na hory,
              ale kolo je moc namáhavé.
            </p>
            <p>
              Táta: No tak asi půjdu s kolegy na basket. Pepo, chodíte ještě se
              Štěpánem na squash?
            </p>
            <p>
              Pepa: Jo, ale dlouho jsme nebyli. Ted‘ v létě asi začneme s
              tenisem, když se dá být i venku. Jen si budu muset koupit novou
              raketu.
            </p>
            <p>
              Gábina: Tenis? To bych šla docela taky. Jana chodí už půl roku a
              má hrozně sympatického trenéra.
            </p>
            <p>
              Pepa: Ty a sport? To nemyslíš vážně! Jdi radši s kamarádkami do
              kina.
            </p>
            <p>
              Máma: Víte co? Já mám na sobotu večer domluvený aerobic s holkami
              z práce, takže stejně nemám moc času. Ale v neděli bychom si mohli
              jít alespoň zaplavat, Hynku, když máme bazén za rohem. A v sobotu
              aspoň stihneš ten přenos ze světového poháru v kanoistice, co
              říkáš?
            </p>
            <p>
              Táta: No vidíš, na to jsem skoro zapomněl. Tak to jsem rád, že
              jsme se domluvili.
            </p>
            <p>Gábina: Počkejte, a co můj Cage?</p>

            <p className="fw-bold">2. Ответьте на вопросы:</p>
            <div
              style={{
                backgroundColor: "#aae096",
              }}
            ...
            <p className="fw-bold">Otázky k textu: </p>
      ...
      <div>
        ...
        <div>
          <p className="fw-bold bg-warning">
            Скачайте файл Slang. Zvratná slovesa
          </p>
          <a
            href="https://czecha2bucket.s3.amazonaws.com/lekce_2/Slang.+Zvratn%C3%A1+slovesa.pdf"
            target="blank"
          >
            Slang. Zvratná slovesa
          </a>
        </div>

        <div>
          <p className="fw-bold">Se или si, или вообще не надо?</p>
          <p>
            Одна из самых востребованных тем в чешском. Ее можно объяснять
            несколько раз, подходить с разных сторон и приводить много примеров.
          </p>
          <p>
            На этом видео есть объяснение, оно "базовое", но все же студентам
        ...
        <div>
          <p className="fw-bold bg-warning">
            Посмотрите видео с Дарьей — Zvratná zájmena.
          </p>
          <iframe
            width="653"
            height="367"
          ...
          <p>
            Надеемся, наболевший вопрос о разнице наконец-то уменьшится в своих
            размерах.
          </p>

          <p>
            Полностью он не исчезнет, так как нужен более длительное наблюдение
            за языком и анализ всего услышанного и увиденного вокруг.
          </p>
        </div>
      </div>

      <div>
        <h2>MODÁLNÍ SLOVESA</h2>
        <div>
          <p>
            Важнейшие модальные глаголы в чешском языке -
            <strong>"chtít", "moct" ("moci"), "muset", "smět".</strong>
          </p>
          <p>
            Все они различаются по значению и употреблению, выражая различные
            оттенки долженствования, необходимости, возможности и желания.
          </p>

          <p className="fw-bold bg-warning">Посмотрите видео.</p>
          <iframe
            width="653"
            height="367"
          ...
          <p className="fw-bold">
            Ниже представлена таблица "Модольные глаголы".
          </p>
          <p>
            <i>
              Вы можете ее сохранить и распечатать, либо переписать в свою
              рабочую тетрадь.
            </i>
          </p>
          <img
        ...
        <div>
          <p className="fw-bold bg-warning">
            Для закрепления материала выполните дополнительные упражнения.
          </p>

          <div>
            <p className="fw-bold">
              1. Z uvedených vět tvořte věty s modálním slovesem:
            </p>
            <p>
            ...
            <div className="my-4">
              <p className="text-upeercase fw-bold">CHTÍT</p>
              <p>
                Jdu do Hubu. Zítra vstane brzo. Díváme se na televizi. Budeš
                dlouho číst?
              </p>
              <p>Jedou na dovolenou k moři.</p>
            </div>
            <div className="my-4">
              <p className="text-upeercase fw-bold">MOCT</p>
              <p>
                Vysvětlíš mi tu gramatiku? K tomu ti už nic neřeknu. V té věci
                nám nepomůžou. Zopakujete mi tu otázku? O víkendu spíme dlouho.
              </p>
            </div>
            <div className="my-4">
              <p className="text-upeercase fw-bold">SMĚT</p>
              <p>
                Zde se nekouří. Při testu používejte slovník. Jdeme dovnitř?
                Nejmladší dcera si to dovolí. Nechodím domů pozdě v noci.
              </p>
            </div>
            <div className="my-4">
              <p className="text-upeercase fw-bold">MUSET </p>
              <p>
                Něco vám řeknu. Jirka dává pozor na sestru. Studenti si opakují
                slovíčka. Ten překlad pošleme do soboty. Přečteš tu knihu za tři
                dny?
              </p>
            </div>
            <div className="my-4">
              <p className="text-upeercase fw-bold">UMĚT </p>
              <p>
                Mluvíte anglicky? Hraješ na klavír? Pavlík ještě nechodí. Moji
                přátelé hrají tenis.
              </p>
            </div>
            <div className="my-4">
              <p className="text-upeercase fw-bold">MÍT </p>
              <p>
                Zeptáme se jí na to. Co děláte? Pomůžou mu s úkolem. Nic mi
                neřekneš? Zavřu okno.
              </p>
            </div>
              ...
              <Collapse in={keys.getValue(3)} timeout={2000}>
                <div>
                  <div className="my-4">
                    ...
                    <p>
                      <i>
                        chci jít, chce vstát, chceme se dívat, budeš chtít číst,
                        chtějí jet
                      </i>
                    </p>
                  </div>
                  <div className="my-4">
                    ...
                    <p>
                      <i>
                        můžeš vysvětlit, nemůžu k tomu nic říct, nemůžou pomoct,
                        můžete zopakovat, můžeme spát
                      </i>
                    </p>
                  </div>
                  <div className="my-4">
                    ...
                    <p>
                      <i>
                        nesmí se zde kouřit, smíte používat, smíme jít, smí si
                        to dovolit, nesmím chodit pozdě
                      </i>
                    </p>
                  </div>
                  <div className="my-4">
                    ...
                    <p>
                      <i>
                        musím říct, musí dávat pozor, musí si opakovat, musíme
                        poslat, musíš přečíst
                      </i>
                    </p>
                  </div>
                  <div className="my-4">
                    ...
                    <p>
                      <i>
                        umíte mluvit, umíš hrát, neumí chodit, umí/umějí hrát
                      </i>
                    </p>
                  </div>
                  <div className="my-4">
                    ...
                    <p>
                      <i>
                        máme se jí na to zeptat, máte dělat, mají nám pomoct,
                        nemáš mi něco říct, mám zavřít
                      </i>
                    </p>
                  </div>
                </div>
          ...
          <div>
            <p className="fw-bold">
              2. Pomocí modálního slovesa vyjádřete možnost (возможность),
              nutnost (необходимость), přání (желание), zákaz (запрет),
              doporučení (совет). Napište v závorkách, co jste vyjádřili ve
              větě.
            </p>
            <p>
              <i>
                Vzor: Přijď v sobotu. (muset) &#8594; Musíš přijít v sobotu.
                (nutnost).
              </i>
            </p>
                ...
                <div>
                  ...
                  <p>
                    ...
                    <i>
                      ...
                      <strong>
                        V této restauraci nesmějí lidé kouřit. (zákaz)
                      </strong>
                    </i>
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    <i>
                      ...
                      <strong>
                        Je sucho, máme zalévat zahradu. (doporučení)
                      </strong>
                    </i>
                  </p>
                </div>
